...
namespace lve {
	...
	void FirstApp::createPipelinelayout() {
		...
		pushConstantRange.size = sizeof(SimplePushConstantDate);
	...
	void FirstApp::recreateSwapChain() {
		...
		vkDeviceWaitIdle(lveDevice.device());
		//lveSwapChain = nullptr; /////////// clearing the previous swapchain cuz two swapchains cant coexist on this system
